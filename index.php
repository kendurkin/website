                    ...
                    <div id="extras" class="col-sm-12">
                        <div class="panel panel-primary">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">President, <a href="http://fordham-css.github.io/">Computing Sciences Society</a></h3>
                                </div>
                            ...
                            <div class="panel panel-default" style="margin-bottom:0;">
                                ...
                                <div class="panel-body">
                                    ...
                                    This upcoming year I'll be responsible for several methods of communication and publication with the student body
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">      
                ...
                <div id="this-carousel-id" class="carousel slide"><!-- class of slide for animation -->
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="item">
                        <img src="/res/experience/uber-logo.jpg" class="img-rounded"/>
                        <div class="carousel-caption">
                              <div class="description col-xs-12">
                            <div class="panel panel-primary">
                                    <div class="panel-heading">
                                        <h3 class="panel-title">Brand Ambassador, <a href="http://uber.com/">Uber</a></h3>
                                    </div>
                                    <div class="panel-body">
                                        <strong>Spring 2014 - Present</strong>
                                    </div>
                                    <div class="panel-body">
                                        Marketing position taken up during the school year in which I spread the word throughout New York City about the car service known as Uber in order to generate signups.  Emphasis is put on people skills and hustle in this position, which enables me to get closer to the startup culture as well as how this particular one is received within the NYC community.  
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div id="links" class="col-md-6">
                        <ul>
                            ...
                            <li class="link"><a href="https://github.com/kendurkin"><img src="/res/contact/github-icon.png"/></a><span class="icon_description">Where my code lives.</span></li>
                            <li class="link"><a href="https://linkedin.com/in/KenDurkin"><img src="/res/contact/linkedin-icon.png"/></a><span class="icon_description">Me in a suit.</span></li>
                ...
                <div class="row">
                    <div class="text-center span4 col-4 col-offset-4 offset4">
                        ...
                        <ul class="unstyled list-unstyled list-inline">
                            ...
                            <li><a href="https://www.github.com/kendurkin" target="_blank">
                                Github
                            </a></li>
                            <li><a href="https://plus.google.com/+KennethDurkin" rel="publisher" target="_blank">
                                Google
                            </a></li>
                            <li><a href="http://linkedin.com/in/kendurkin" target="_blank">
                                LinkedIn
                            </a></li>
                        </ul>
